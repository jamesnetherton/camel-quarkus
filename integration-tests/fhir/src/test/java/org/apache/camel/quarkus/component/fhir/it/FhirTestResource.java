...
public class FhirTestResource implements QuarkusTestResourceLifecycleManager {
    ...
    public Map<String, String> start() {
        ...
        try {
            ...
            DockerImageName imageName = fhirVersion.getContainerImageName();
    ...
    enum FhirVersion {
        ...
        public DockerImageName getContainerImageName() {
            if (name().startsWith("DSTU")) {
                return TestContainer.FHIR_DSTU.getImageName();
            }
            return TestContainer.FHIR.getImageName();
        }
