...
class BeanioTest {
    ...
    void marshal(String type) throws Exception {
        ...
        String expected = IOUtils.toString(BeanioTest.class.getResourceAsStream("/employees." + type.toLowerCase()),
    ...
    @ParameterizedTest
    @ValueSource(strings = { "CSV", "DELIMITED", "FIXEDLENGTH", "XML" })
    void unmarshal(String type) throws Exception {
        RestAssured.given()
                .queryParam("type", type)
                .contentType(ContentType.TEXT)
                .body(BeanioTest.class.getResourceAsStream("/employees." + type.toLowerCase()))
    ...
    void marshalAnnotated() throws Exception {
        ...
        String expected = IOUtils.toString(BeanioTest.class.getResourceAsStream("/employees.csv"),
                StandardCharsets.UTF_8);
    ...
    @Test
    void unmarshalAnnotated() throws Exception {
        RestAssured.given()
                .contentType(ContentType.TEXT)
                .body(BeanioTest.class.getResourceAsStream("/employees.csv"))
